...
public class TestRobot5 {
     ...
     */
    public TestRobot5(String host, int port)
    {
        this.host = host;
        this.port = port;
        this.robot = this;
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        TestRobot5 robot = new TestRobot5("http://127.0.0.1", 50000);
        ...
        */
        ...
        for(Position pos : path) {
            ...
            if (roboPos.getDistanceTo(pos) >= LOOKAHEAD) {
                double gamma = (2 * pos.getX()) / (LOOKAHEAD * LOOKAHEAD);
