...
public class TestRobot9
{
     ...
     */
    public TestRobot9(String host, int port)
    {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        TestRobot9 robot = new TestRobot9("http://127.0.0.1", 50000);
        robot.readFile();
    ...
    private void run() throws Exception
    {
        ...
        while(pathStack!=null ) {
            ...
            */
            ...
            if(diffAngle > 180){diffAngle = diffAngle - 360;}
            double relativeX = cos(diffAngle) * distance;
            double gamma = (2 * relativeX) / (distance * distance);
    ...
    {
        return sqrt((x0 - xp) * (x0 - xp) + (y0 - yp) * (y0 - yp));
    }
