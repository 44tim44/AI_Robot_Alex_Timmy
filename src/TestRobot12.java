...
public class TestRobot12
{
     ...
     */
    public TestRobot12(String host, int port)
    {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        TestRobot12 robot = new TestRobot12("http://127.0.0.1", 50000);
        robot.readFile();
    ...
    //Calculate distance to the goal point from the robot
        double rx = (goalPos.getX()-pos.getX())*cos(robotAngle)+(goalPos.getY()-pos.getY())*sin(robotAngle);
        double ry = (goalPos.getX()-pos.getX())*sin(robotAngle)+(goalPos.getY()-pos.getY())*cos(robotAngle);
        double length = pythHyp(rx, ry);
